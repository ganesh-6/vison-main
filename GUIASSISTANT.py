...
try:
	...
	import timer
	from FACE_UNLOCKER import clickPhoto
	import dictionary
	import ToDo
...
def main(text):
		...
		if 'scan surrounding' in text:
			speak("Scanning Surrounding...",True)
			from Utils.Image_Captioning.model import predict 
			c = predict()
			speak(c)
			return
